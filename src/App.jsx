...
function App() {
  ...
  <span className=''>
  Use <a className=" underline after:content-[url('/cover/static/link-external-small-ltr-progressive.svg')] after:ml-0.5" href="https://rafiz001.github.io/sheet-routine/">Sheet Routine</a> to get teachers name, course code automatic.</span>
</div>
